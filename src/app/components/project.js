...
export default function Project({project, language}) {
    ...
    return (
        <li className="py-6">
            <a className="lg:bg-transparent rounded-lg lg:rounded-none group relative grid gap-6 transition-all sm:grid-cols-8 sm:gap-8 md:gap-6 lg:hover:!opacity-100" href={project.url} target="_blank" rel="noreferrer noopener" aria-label={`${project.alt} (opens in a new tab)`}>
